...
public class Cliente extends Persona {
	...
	public boolean crearReserva(Aplicacion aplicacion, String deseada, String sedeReclamo,String sedeDevolucion, String fechaReservaReclamo, String fechaReservaDevolucion,
		...
		if (carroA!=0) {
			...
			aplicacion.setNumReservas(aplicacion.getNumReservas()+1);
			...
			reserva.generarFacturaPDF( horaDevolucion, seguros, conductoresAdicionales);
			//persistencia
					String textoAAgregar = "\n"+String.valueOf(aplicacion.getNumReservas()+1)+";"+this.getLogin()+";"+cate.getNombre()+";"+reserva.getMontoAPagar()+";"+sedeReclamo+";"+sedeDevolucion+";"+fechaReservaDevolucion+";"+horaDevolucion+";"+String.valueOf(carroA)+";"+seguros+";"+conductoresAdicionales+";"+fechaReservaReclamo;
			try {
	            ...
	            System.out.println("Peristencia Actualizada reserva");
	        } catch (IOException e) {
	            e.printStackTrace();
	        }	
	...
	private boolean carroSeriveTipo(Vehiculo carro, String categoria) {
		...
		*/
		...
		//no se pone nada
		//auto 2
		else if(carro.getCategoria().equals("atv") && categoria.equals("automovil")){
			return true;}
		//moto 3
		else if(carro.getCategoria().equals("atv") && categoria.equals("moto")){
			return true;}
		else if(carro.getCategoria().equals("automovil") && categoria.equals("moto")){
			return true;}
		//patineta 4
		else if(carro.getCategoria().equals("atv") && categoria.equals("patineta eléctrica")){
			return true;}
		else if(carro.getCategoria().equals("automovil") && categoria.equals("patineta eléctrica")){
			return true;}
		else if(carro.getCategoria().equals("moto") && categoria.equals("patineta eléctrica")){
			return true;}
		//b.elec 5
		else if(carro.getCategoria().equals("atv") && categoria.equals("bicicleta eléctrica")){
			return true;}
		else if(carro.getCategoria().equals("automovil") && categoria.equals("bicicleta eléctrica")){
			return true;}
		else if(carro.getCategoria().equals("moto") && categoria.equals("bicicleta eléctrica")){
			return true;}
		else if(carro.getCategoria().equals("patineta eléctrica") && categoria.equals("bicicleta eléctrica")){
			return true;}
		//bicicleta 6 
		else if(carro.getCategoria().equals("atv") && categoria.equals("bicicleta")){
			return true;}
		else if(carro.getCategoria().equals("automovil") && categoria.equals("bicicleta")){
			return true;}
		else if(carro.getCategoria().equals("moto") && categoria.equals("bicicleta")){
			return true;}
		else if(carro.getCategoria().equals("patineta eléctrica") && categoria.equals("bicicleta")){
			return true;}
		else if(carro.getCategoria().equals("bicicleta eléctrica") && categoria.equals("bicicleta")){
			return true;}
		else {return false;}
	}

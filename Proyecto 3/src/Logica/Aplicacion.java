	...
	public void cargarAdminGeneral(String archivoAdminGeneral){
	 ...
	 public void cargarAdminsLocales(String archivoAdminsloc) {
			try {
				...
				// TODO: handle exception
				System.out.println("Error Cargando Datos AdminLoc");
			}
	 ...
	 public void cargarCategorias(String archivoAdminsloc) {
			try {
				...
				while((linea=br.readLine()) != null) {
					...
					float valorExtraSeguroAdd = new Float( partes[5].trim());
					Categoria categoria = new Categoria(nombre, tarifaTemporadaAlta, tarifaTemporadaBaja,valorExtraOtraSede, valorExtraConductorAdd,valorExtraSeguroAdd);

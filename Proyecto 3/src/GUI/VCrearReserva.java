...
public class VCrearReserva extends JFrame {
	...
	private JComboBox<String>  sedeRec;
	private JComboBox<String>  sedeRet;
	...
	public VCrearReserva(VCliente Vcliente, Cliente cliente, Aplicacion app) {
        ...
        sedeRec = new JComboBox<>(app.getSedes().keySet().toArray(new String[0]));
        JLabel label3 = new JLabel ("Ingrese la sede donde va a regresar el vehiculo: ");
        sedeRet = new JComboBox<>(app.getSedes().keySet().toArray(new String[0]));
	    ...
	    crearReserva.addActionListener(new ActionListener() {    
            ...
            public void actionPerformed(ActionEvent e) {	
        		try {
        			...
        			String sedeReclamo = (String)sedeRec.getSelectedItem();
        			String sedeRetorno = (String)sedeRet.getSelectedItem();
        			...
        			boolean hayCarro = cliente.crearReserva(app, cat, sedeReclamo, sedeRetorno, fechaReclamo,fechaRetorno, horaRetorno,seg,conducAd);
        			if (hayCarro == false) {
        			...
        			JOptionPane.showMessageDialog(null, "SE HA CREADO LA RESERVA Y SU FACTURA EN PDF. PAGUE  CUANDO RECLAME EL VEHICULO", "CREADA",JOptionPane.INFORMATION_MESSAGE);
        			}
        		} catch (Exception a) {
        			 a.printStackTrace();

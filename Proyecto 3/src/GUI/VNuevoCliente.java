...
public class VNuevoCliente extends JFrame {
	...
	public VNuevoCliente(regresable vAdminLoc, Aplicacion app) {
		...
		NuevoEmpleado.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {	
        		try {
        			...
        			AdminLocal.agregarCliente(app, Fnombre, Fapellido, FfechaNacimiento, Fnacionalidad, Flogin, Fpassword, Fnumero, Fcvv, Fid_licencia, Fpais, FfechaVencimiento, Ffoto, Ftel);
